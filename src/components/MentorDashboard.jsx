...
//       // In a real app, check for actual wallet connection here
...
//         mentorAddress: milestone.mentorAddress || milestone.assignedMentor || connectedAddress,
//         verified: Boolean(milestone.verified),
//         rejected: milestone.rejected || false,
//         proofHash: milestone.proofHash || `QmStartup${startupId}Milestone${milestoneIndex}ProofHash`,
...
//   // Generate mock milestones for demo with consistent data
//   const generateMockMilestones = () => {
//     if (!connectedAddress) return [];
    
//     // Create deterministic verification status based on startup name
//     const getVerificationStatus = (startupName, milestoneIndex) => {
//       // Use startup name hash to create consistent verification status
//       const hash = startupName.split('').reduce((a, b) => {
//         a = ((a << 5) - a) + b.charCodeAt(0);
//         return a & a;
//       }, 0);
      
//       // Make some milestones verified, some pending
//       if (milestoneIndex === 0) {
//         return Math.abs(hash) % 3 === 0; // About 1/3 verified
//       } else {
//         return Math.abs(hash) % 4 === 0; // About 1/4 verified  
//       }
//     };
...
//         verified: getVerificationStatus(startup.name, 0),
//         rejected: false,
//         startup: startup
//       },
//       {
...
//         verified: getVerificationStatus(startup.name, 1),
//         rejected: false,
//         startup: startup
//       }
//     ]);
...
//           setResult(`Found ${allMilestones.length} milestone(s) from blockchain`);
//         } else {
//           // No blockchain data, use mock data
...
//       const mockMilestones = generateMockMilestones();
//       setMilestones(mockMilestones);
//       setResult(`Error occurred, showing demo data (${mockMilestones.length} milestones)`);
//     }
...
// View on Aptos Explorer: https://explorer.aptoslabs.com/txn/${mockTxHash}?network=testnet
...
//         setResult(`Milestone verified (demo mode)`);
...
//         // Store manual verification permanently
//         const milestoneKey = `${startupId}-${milestoneIndex}`;
//         setManualVerifications(prev => new Map(prev.set(milestoneKey, true)));
...
//         // Remove the auto-refresh that was overriding manual verifications
//         // setTimeout(() => {
//         //   loadMilestones();
//         // }, 3000);
...
//         // Update blockchain state (this simulates writing to the blockchain)
//         const milestoneKey = `${startupId}-${milestoneIndex}`;
//         setBlockchainVerifications(prev => new Map(prev.set(milestoneKey, true)));
